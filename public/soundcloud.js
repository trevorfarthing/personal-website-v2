  ...
  function (n, t, e) {
    ...
    function u(n) {
      var t,
        ...
        o = "";
      for (
        "//" === n.substr(0, 2) && (n = window.location.protocol + n), r = n.split("/"), t = 0, e = r.length;
        t < e && t < 3;
        t++
      )
        (o += r[t]), t < 2 && (o += "/");
    ...
    function g(n) {
      ...
      for (t in n)
        n.hasOwnProperty(t) &&
          ((e = n[t]), r.push(t + "=" + ("start_track" === t ? parseInt(e, 10) : e ? "true" : "false")));
      return r.join("&");
    }
    function m(n, t, e) {
      var r,
        ...
        (!t || A(n.origin) === A(t.domain)) &&
          (t
            ? (r === L.READY && ((t.isReady = !0), m(t, C), E(C, t)),
              ...
              r !== L.PLAY_PROGRESS || t.playEventFired || ((t.playEventFired = !0), m(t, L.PLAY, [o])),
              (i = []),
              void 0 !== o && i.push(o),
              void m(t, r, i))
